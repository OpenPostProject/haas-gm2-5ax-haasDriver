...
// >>>>> INCLUDED FROM haas/head-head/posts/haas gm2-5ax.cps
...
setPropertyScope("preferredTilt", "post");
setPropertyScope("safeRetractDistance", ["machine", "post"]);
setPropertyScope("safeRetractDistanceZ", ["machine", "post"]);
setPropertyScope("homePositionX", ["machine", "post"]);
setPropertyScope("homePositionY", ["machine", "post"]);
setPropertyScope("homePositionZ", ["machine", "post"]);
setPropertyScope("adjustKnuckleAngle", ["machine", "post"]);
setPropertyScope("knuckleCircular", ["machine", "post"]);
setPropertyScope("baseKnuckleAngle", ["machine", "post"]);
setPropertyScope("useG28", ["machine", "post"]);
